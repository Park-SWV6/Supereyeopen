...
public class ChatRoomService {
    ...
    public ChatRoomEntity createChatRoom(Long mentorId, Long menteeId, String createdAt) {
        ...
        // 멘토 관계 가져오기
        MentorRelationshipsEntity mentorRelationship = mentorRelationshipRepository
                .findByMentorAndMentee(mentor, mentee)
                .orElseThrow(() -> new IllegalArgumentException("멘토 관계가 존재하지 않습니다."));
        ...
        chatRoom.setMentorRelationship(mentorRelationship); // 관계 설정
